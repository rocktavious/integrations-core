...
class DatadogClusterAgentCheck(OpenMetricsBaseCheck):
    ...
    def __init__(self, name, init_config, instances):
        metrics = {
            ...
            'rate_limit_queries_limit': 'rate_limit_queries.limit',
            'rate_limit_queries_period': 'rate_limit_queries.period',
            'rate_limit_queries_remaining': 'rate_limit_queries.remaining',
            'rate_limit_queries_reset': 'rate_limit_queries.reset',
        }
